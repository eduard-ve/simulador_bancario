...
public class InterfazSimulador extends JFrame
{
    ...
    public InterfazSimulador( )
    {
        ...
        cuenta = new SimuladorBancario( "1007397197", "Eduard Velez" );
     ...
     * calcula y muestra el saldo promedio en periodo de tiempo
     */
    public void reqFuncOpcion1( )
    {
        String strMeses = JOptionPane.showInputDialog( this, "Ingrese el número de meses para calcular el promedio:", "Saldo Promedio", JOptionPane.QUESTION_MESSAGE );
        
        // Verifica si el usuario cancelo o cerro el cuadro de dialogo
        if( strMeses != null )
        {
            try
            {
                ...
                if( meses > 0 )
                {
                    // Llama al método del simulador, pasándole el numero de meses
                    // El método metodo1 del simulador ahora esperara un entero meses
                    String resultado = cuenta.metodo1( meses ); 
                    JOptionPane.showMessageDialog( this, resultado, "Saldo Promedio Calculado", JOptionPane.INFORMATION_MESSAGE );
                }
                else
                {
                    JOptionPane.showMessageDialog( this, "El número de meses debe ser mayor a cero.", "Error", JOptionPane.ERROR_MESSAGE );
                }
            }
    ...
    public void reqFuncOpcion2( )
    {
        ...
        JOptionPane.showMessageDialog( this, respuesta, "Resumen de Transacciones del Mes", JOptionPane.INFORMATION_MESSAGE );
    }
